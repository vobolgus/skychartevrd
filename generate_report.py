...
def generate_latex_report(observer_lat, observer_lon, skychart_filename, output_filename="sky_chart_report.tex", number=1, contours=False):
    ...
    # Генерация скайчарта
    generate_png(observer_lon, observer_lat, output_filename=skychart_filename, contours=contours, messier_objects=visible_messier_names)
	...
	\begin{center}
		\large\textbf{Ежедневный скайчарт №""" + str(number) + r"""}
	\end{center}
