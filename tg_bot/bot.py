...
2. Случайный скайчарт в некотором промежутке широт.
    /generate in_range [нижняя граница] [верхняя граница]
Пример:
    /generate in_range -40 60
3. Скайчарт по конкретной широте и звёздному времени
    /generate coords [широта] [звёздное время]
Пример:
...
Для того, чтобы получить ответ на скайчарт можно воспользоваться командой:
    /generate ans [номер]
Пример:
    /generate ans 10
    """)
